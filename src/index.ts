...
// Agora é sua vez! Refatore todos os endpoints de /songs para 
// query builder e implemente o DELETE /songs/:id

// Caso já tenha feito isso ou sobre tempo, implemente uma outra 
// tabela qualquer (sua imaginação) e crie os endpoints com query builder
